      ...
      <blockquote className="text-center lg:mx-auto lg:w-3/5">
        <p className="relative text-xl sm:text-2xl md:text-3xl md:leading-normal font-medium">
          ...
          <span className="relative z-10">
            CalPrabhakar has transformed the way I manage my scheduling. The platform is intuitive,
            reliable, and has saved me countless hours. Highly recommended!
          </span>
        </p>

        <footer className="mt-6">
          <p className="font-semibold">Prabhakar Kumar Jha</p>
